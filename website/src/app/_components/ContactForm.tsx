  ...
  return (
    <>
      <form className="w-full flex flex-col gap-4" onSubmit={onSubmit}>
        ...
        <button
          type="submit"
          className={cn("w-full sm:w-[150px] h-12 flex items-center justify-center cursor-pointer bg-primary text-white py-3 px-9 rounded-lg", {
            "opacity-50 pointer-events-none": name.length === 0 || email.length === 0 || message.length === 0 || loading === true,
          })}
        >
        ...
        {/* <input
          type="submit"
          value="Skicka"
          className={cn("w-full sm:w-fit cursor-pointer bg-primary text-white py-3 px-9 rounded-lg", {
            "opacity-50 pointer-events-none": name.length === 0 || email.length === 0 || message.length === 0 || loading === true,
          })}
        /> */}
      </form>
